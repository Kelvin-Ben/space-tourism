        ...
        {data.destinations.map(
          (dest) =>
            dest.name === activeTab && (
              <article
                key={dest.name}
                className="lg:w-[90%] lg:mx-auto lg:min-h-[50%] lg:flex lg:flex-row 2xl:flex 2xl:justify-between 2xl:mx-auto 2xl:h-[50rem] xl:flex md:w-full items-center justify-around sm:px-10 sm:w-full 2xl:w-[90%] "
              >
                <div className="lg:w-auto lg:justify-normal md:w-full md:flex md:justify-center max-h-[80%] sm:justify-center sm:w-[100%] sm:h-[24rem] sm:items-center">
                  <img
                    src={require(`../../${dest.images.webp}`)}
                    alt={`destination ${activeTab.toLowerCase()}`}
                    className="lg:w-[75%] md:w-[40%] flex-initial md:my-10 md:p-4 sm:mx-auto  sm:w-[60%]"
                  />
                </div>
                <div className="lg:w-[50%] h-full md:w-full md:text-center 2xl:w-[50%] xl:w-[50%] 2xl:pl-[10rem]">
                  <div className="w-full flex justify-end mx-auto items-end md:h-[5rem] 2xl:justify-start xl:justify-start lg:justify-start">
                  ...
                  <p className="lg:w-[75%] lg:text-start lg:text-2xl font-barlow mb-20 md:text-3xl text-customBlue md:w-[80%] md:mx-auto md:align-middle tracking-wider sm:w-[90%] sm:mx-auto sm:text-3xl sm:text-center xs:text-2xl xs:w-full xs:text-center 2xl:w-[65%] xl:w-[70%] 2xl:text-3xl xl:text-3xl">
                    {dest.description}
                  </p>
